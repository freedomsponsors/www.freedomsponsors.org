...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.can_change_username'
        db.add_column(u'core_userinfo', 'can_change_username',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.can_change_username'
        db.delete_column(u'core_userinfo', 'can_change_username')
