...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.date_created'
        db.add_column(u'core_userinfo', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 31, 0, 0)),
                      keep_default=False)

        # Adding field 'UserInfo.date_last_updated'
        db.add_column(u'core_userinfo', 'date_last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.date_created'
        db.delete_column(u'core_userinfo', 'date_created')

        # Deleting field 'UserInfo.date_last_updated'
        db.delete_column(u'core_userinfo', 'date_last_updated')
