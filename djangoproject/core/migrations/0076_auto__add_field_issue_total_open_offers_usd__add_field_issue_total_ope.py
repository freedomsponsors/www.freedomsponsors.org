...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.total_open_offers_usd'
        db.add_column(u'core_issue', 'total_open_offers_usd',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=8),
                      keep_default=False)

        # Adding field 'Issue.total_open_offers_btc'
        db.add_column(u'core_issue', 'total_open_offers_btc',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=8),
                      keep_default=False)

        # Adding field 'Issue.total_paid_offers_usd'
        db.add_column(u'core_issue', 'total_paid_offers_usd',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=8),
                      keep_default=False)

        # Adding field 'Issue.total_paid_offers_btc'
        db.add_column(u'core_issue', 'total_paid_offers_btc',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=8),
                      keep_default=False)

        # Adding field 'Issue.count_solutions_done'
        db.add_column(u'core_issue', 'count_solutions_done',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Issue.count_solutions_in_progress'
        db.add_column(u'core_issue', 'count_solutions_in_progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.total_open_offers_usd'
        db.delete_column(u'core_issue', 'total_open_offers_usd')

        # Deleting field 'Issue.total_open_offers_btc'
        db.delete_column(u'core_issue', 'total_open_offers_btc')

        # Deleting field 'Issue.total_paid_offers_usd'
        db.delete_column(u'core_issue', 'total_paid_offers_usd')

        # Deleting field 'Issue.total_paid_offers_btc'
        db.delete_column(u'core_issue', 'total_paid_offers_btc')

        # Deleting field 'Issue.count_solutions_done'
        db.delete_column(u'core_issue', 'count_solutions_done')

        # Deleting field 'Issue.count_solutions_in_progress'
        db.delete_column(u'core_issue', 'count_solutions_in_progress')
    ...
    models = {
        ...
        u'core.issue': {
            ...
            'count_solutions_done': ('django.db.models.fields.IntegerField', [], {}),
            'count_solutions_in_progress': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'total_open_offers_btc': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '8'}),
            'total_open_offers_usd': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '8'}),
            'total_paid_offers_btc': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '8'}),
            'total_paid_offers_usd': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '8'}),
        ...
        u'core.userinfo': {
            ...
            'can_change_username': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            'date_last_updated': ('django.db.models.fields.DateTimeField', [], {}),
