...
class TestFrespo_utils (TestCase):
    ...
    def test_strip_protocol(self):
        url_input_1 = 'http://docs.oracle.com'
        url_input_2 = 'https://www.youtube.com'
        url_input_3 = 'facebook.com'
        self.assertEqual(strip_protocol(url_input_1), 'docs.oracle.com')
        self.assertEqual(strip_protocol(url_input_2), 'www.youtube.com')
        self.assertEqual(strip_protocol(url_input_3), 'facebook.com')
