...
def issue(request):
    ...
    _issue = {
        ...
        'total_open_offers_usd': 120.00,
        'total_paid_offers_usd': 30.00,
        'total_paid_offers_btc': 0.45,
        'get_status': 'open',
        'getComments': [
